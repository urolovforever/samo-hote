        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="flex gap-1.5">
            {(['all', 'income', 'expense'] as const).map(t => (
              <button
                ...
                className={`px-2.5 sm:px-3 py-2 rounded-lg text-[11px] sm:text-xs font-medium transition-all ${
                  filterType === t
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-[#161923] border border-white/[0.06] rounded-xl pl-9 pr-3 py-2 text-[11px] sm:text-xs text-white/50 focus:outline-none focus:border-amber-500/30"
            />
          </div>
        </div>
      </div>
              ...
              <div key={tx.id} className="px-3 sm:px-5 py-3 sm:py-4 hover:bg-white/[0.02] transition-colors group">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-[11px] text-white/25 mt-0.5 flex-wrap">
                    ...
                    {canModify(tx.admin, tx.date) && (
                      <div className="flex items-center gap-1 mt-1.5 sm:mt-1">
                        <button
